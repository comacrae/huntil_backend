...
class Site(Base):
  ...
  geography: Mapped["Geography"] = relationship(back_populates="site")
  harvest: Mapped[List["Harvest"]] = relationship(backpopulates="site")
...
class Harvest(Base):
  ...
  site: Mapped["Site"] = relationship(back_populates="harvest")
